...
public class DeviceReservationController extends AbstractCRUDCtrl<DeviceReservation> {
    ...
    @PostFilter("filterObject.user.id == authentication.getUser().getId() || hasAuthority('OP_TEAM')")
    ...
    @PostAuthorize("returnObject.user.id == authentication.getUser().getId() || hasAuthority('OP_TEAM')")
